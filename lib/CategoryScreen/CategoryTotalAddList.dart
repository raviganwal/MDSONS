...
import 'package:mdsons/CategoryScreen/CategoryTotalAddModel.dart';
...
//---------------------------------------------------------------------------------------------------//
class CategoryTotalAddList extends StatefulWidget {

  static String tag = 'CategoryTotalAddList';
  final String value;
  final String value4;
  final String value5;
//---------------------------------------------------------------------------------------------------//
  CategoryTotalAddList({Key key, this.value, this.value4, this.value5}) : super(key: key);
  @override
  _CategoryTotalAddList createState() => new _CategoryTotalAddList();
}
//---------------------------------------------------------------------------------------------------//
class _CategoryTotalAddList extends State<CategoryTotalAddList> {
  List data;
  List data1;
  String categoryid;
  List<Posts> _list = [];
