...
//---------------------------------------------------------------------------------------------------//
  ProductCheckOut({Key key, this.value, this.value7, this.value8}) : super(key: key);
  @override
  _ProductCheckOutList createState() => new _ProductCheckOutList();
}
//---------------------------------------------------------------------------------------------------//
class _ProductCheckOutList extends State<ProductCheckOut> {
