...
//---------------------------------------------------------------------------------------------------//
  HomeCheckOut({Key key, this.value, this.value5, this.value6}) : super(key: key);
  @override
  _HomeCheckOutList createState() => new _HomeCheckOutList();
}
//---------------------------------------------------------------------------------------------------//
class _HomeCheckOutList extends State<HomeCheckOut> {
...
//--------------------------------------------------------------------------------//
  upload(String fileName) {
    http.post(uploadEndPoint, body: {
      ...
      "name": fileName,
      "UserId": Userid,
      "TotalAmount": widget.value5.toString(),
    }).then((result) {
      ...
      // print("uploadEndPoint"+uploadEndPoint.toString());
      print("UserId" + Userid);
      print("TotalAmount" + widget.value5.toString());
      print("uploadEndPoint" + uploadEndPoint.toString());
  ...
  void _handleSubmitted() {
    if(UploadImagestatus == true){
      showInSnackBar(OrderNumber.toString());
      Navigator.push(
        context,
        MaterialPageRoute(
