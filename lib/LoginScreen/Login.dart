...
import 'package:mdsons/style/theme.dart' as Theme;
import 'package:mdsons/utils/bubble_indication_painter.dart';
import 'dart:async';
...
class _LoginState extends State<Login>
  ...
  TextEditingController signupMobilewController = new TextEditingController();
  TextEditingController signupConfirmPasswordController = new TextEditingController();


  var focusNode = new FocusNode();
  var focusNodelogin = new FocusNode();
  String aa = "Individual";

  getData(String username, String email,String password,String mobile) async {

    if (username.isEmpty && password.isEmpty) {
      _showOnTapMessage(context, "Incorrect Form Fill!");
    }
    else if (email.isEmpty) {
      _showOnTapMessage(context, "Enter email!");
    }
    else if (password.isEmpty) {
      _showOnTapMessage(context, "Enter password!");
    }
    else if (mobile.isEmpty) {
      _showOnTapMessage(context, "Enter mobile!");
    }
    else {
      String profile =
          'http://gravitinfosystems.com/MDNS/MDN_APP/Registration.php?Name=' +
              username +
              "&Email=" +
              email +
              "&Password=" +
  ...
  getDataLogin(String email,String password) async {

    if (email.isEmpty && password.isEmpty) {
      _showOnTapMessage(context, "Incorrect email or Password!");
    }
    else if (email.isEmpty) {
      _showOnTapMessage(context, "Enter email!");
    }
    ...
    //  Count_Product = dataLogin['data']['Count_product'];
     ...
     // print(Count_Product);
      ...
      if (statuslogin == 1) {
        if (role == 'Individual') {
          //print("role"+role);
          new Preferences().storeDataAtLogin(dataLogin);
  ...
  Future<bool> _onWillPopSuccess() {
    return showDialog(
      context: context,
      builder: (context) => new AlertDialog(
        title: new Text('SignUp Successfully'),
        content: new Text('Do you want to Continue in App'),
        actions: <Widget>[
          new FlatButton(
