...
//---------------------------------------------------------------------------------------------------//
  TotalCheckOut({Key key, this.value, this.value7, this.value8}) : super(key: key);
  @override
  _TotalCheckOutList createState() => new _TotalCheckOutList();
}
//---------------------------------------------------------------------------------------------------//
class _TotalCheckOutList extends State<TotalCheckOut> {
